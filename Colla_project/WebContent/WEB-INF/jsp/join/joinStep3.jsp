					...
					<div class="content flex">
						<div class="joinBox-Body">
							<form action="joinMember" method="post" id="joinMemberForm">
								...
								<div>
									<h4>PASSWORD</h4>
									<input type="password" name="pw" id="pw"> <span
										id="checkPw" class="checkSentenceRed"></span>
								</div>
								<div>
									<h4>NAME</h4>
									<input type="text" name="name" id="name"> <span
										id="checkName" class="checkSentenceRed"></span>
								</div>
								<div class="joinCheckbox">
									<input type="checkbox" id="checkbox" value="1"
										class="joinCheckboxInput"> COLLA에서 제공하는 서비스 약관에 동의합니다.
									<br>
